...
def customise_pu_protons_ctpps(process):
	...
	process.MINIAODSIMoutput.outputCommands.extend(cms.untracked.vstring('keep PPSGenDataPPSSpectrometer_*_*_*','keep PPSSimDataPPSSpectrometer_*_*_*','keep PPSRecoDataPPSSpectrometer_*_*_*','keep TotemRPDigiedmDetSetVector_*_*_*'))## add CTPPS eventContent
